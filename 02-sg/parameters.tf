resource "aws_ssm_parameter" "vpn_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/vpn_sg_id"
  type  = "String"
...
resource "aws_ssm_parameter" "mongodb_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/mongodb_sg_id"
  type  = "String"
  value = module.mongodb.sg_id
}

resource "aws_ssm_parameter" "mysql_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/mysql_sg_id"
  type  = "String"
  value = module.mysql.sg_id
}

resource "aws_ssm_parameter" "redis_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/redis_sg_id"
  type  = "String"
  value = module.redis.sg_id
}

resource "aws_ssm_parameter" "rabbitmq_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/rabbitmq_sg_id"
  type  = "String"
  value = module.rabbitmq.sg_id
}

resource "aws_ssm_parameter" "cart_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/cart_sg_id"
  type  = "String"
...
resource "aws_ssm_parameter" "payment_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/payment_sg_id"
  type  = "String"
  value = module.payment.sg_id
}

resource "aws_ssm_parameter" "shipping_sg_id" {
  name  = "/gmd/${var.project_name}/${var.environment}/shipping_sg_id"
  type  = "String"
